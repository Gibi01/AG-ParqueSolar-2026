...
@pytest.mark.parametrize(
    ...
    [
        ...
        (-31.75, -60.75, (-31.8, -60.8)),  # round-half-to-even/away boundary case
        (-31.0, -60.0, (-31.0, -60.0)),
...
def test_predict_nearest_era5_grid_point_groups_nearby_cells_together():
    # Two grid-cell centroids close enough to plausibly share the same
    # ~9km ERA5-Land point should predict the SAME point.
